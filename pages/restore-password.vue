<template>
    <div class="login">
        ...
        <div class="description">
            Введите электронную почту, указанную при регистрации. На неё придёт код для востановления пароля.
        </div>
        ...
        <transition name="bounce">
          <Myalert v-if="success"
              ...
              :content="`<p>Пароль успешно изменён и отправлен на ваш e-mail</p> <a href='mailto: ${email}'>${email}</a>`"
              @close="closeAlert"                
          >            
          </Myalert>
        </transition>
